<template>
    ...
    <div v-if="stateNumber === 0" class="wd-box flex items-start w-full p-8!">
        ...
        <div class="wd-content items-center flex flex-col w-full p-4 h-full!">
            ...
            <input type="number" v-model.number="wdInput" class="p-1.5! w-80% max-w-2xl opacity-80 mb-40!"
                :readonly="isReadonly">
    ...
    <div v-else-if="stateNumber !== 0" class="wd-box flex items-start w-full p-8! relative!">
        ...
        <div class="wd-left-sidebar flex flex-col items-end gap-8">
            ...
            <el-button class="w-30! h-15! fw-700! opacity-0 hover:cursor-default"></el-button>
            <el-button class="w-30! h-15! fw-700! opacity-0 hover:cursor-default"></el-button>
            <el-button class="w-30! h-15! fw-700! opacity-80">打印凭条</el-button>
        </div>

        <div class="wd-content items-center flex flex-col w-full p-4 h-full!">
            <h1 class="mb-16! text-5! font-900! p-t-4! color-#333">{{ stateInfo }}</h1>
        ...
        <div class="wd-right-sidebar flex flex-col items-end gap-8">
            ...
            <el-button class="w-30! h-15! opacity-80 color-red! fw-700!" @click="stateNumber = 0"> 返回</el-button>
        </div>
    </div>
